...
Add with `dep ensure -add github.com/mbsulliv/termui`. With Dep, `/v3` should *not* be included in the import statements.
...
import (
	...
	ui "github.com/mbsulliv/termui/v3"
	"github.com/mbsulliv/termui/v3/widgets"
)
...
- [wiki](https://github.com/mbsulliv/termui/wiki)
